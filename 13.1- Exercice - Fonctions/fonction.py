...
def frequences_lettres(txt):
    cpt = 0
    for element in tab_lettres[0]:
        freq = txt.count(tab_lettres[0][cpt])
        tab_lettres[1][cpt] = freq
        cpt += 1

    print(tab_lettres)


frequences_lettres(texte)
print()
frequences_lettres("hello world")
print()
